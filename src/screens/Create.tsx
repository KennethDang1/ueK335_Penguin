...
export default function CreatePenguin() {
    ...
    const handleSubmit = () => {
        if (!species || !island || !beakLengthMm || !beakDepthMm || !flipperLengthMm || !bodyMassG || !sex) {
    ...
    return (
        <ScrollView contentContainerStyle={{ paddingTop: 60, paddingHorizontal: 30, paddingBottom: 30 }}>
            ...
            <TextInput value={beakLengthMm} onChangeText={setBeakLengthMm} style={styles.input} keyboardType="numeric" />

            <Text>Beak Depth (mm)</Text>
            <TextInput value={beakDepthMm} onChangeText={setBeakDepthMm} style={styles.input} keyboardType="numeric" />

            <Text>Flipper Length (mm)</Text>
            <TextInput value={flipperLengthMm} onChangeText={setFlipperLengthMm} style={styles.input} keyboardType="numeric" />

            <Text>Body Mass (g)</Text>
            <TextInput value={bodyMassG} onChangeText={setBodyMassG} style={styles.input} keyboardType="numeric" />
